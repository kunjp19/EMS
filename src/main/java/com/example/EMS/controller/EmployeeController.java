...
public class EmployeeController {
    ...
    public List<EmployeeDetails> getEmployees() {
        return (List<EmployeeDetails>) employeeService.getAllEmployee();
    }
    ...
    public String saveEmployeeDetails(@RequestBody EmployeeDetails employeeDetails) {
        return String.format("Employee with %shas been added/updated", employeeService.persistEmployeeDetais(employeeDetails));
    }
